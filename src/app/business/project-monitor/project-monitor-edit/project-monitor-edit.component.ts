...
@Component({
  selector: 'app-project-monitor-edit',
  templateUrl: './project-monitor-edit.component.html',
  styleUrls: ['./project-monitor-edit.component.css']
})
export class ProjectMonitorEditComponent implements OnInit {
